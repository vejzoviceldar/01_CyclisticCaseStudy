...
2. Partnering with local attractions to offer discounts to members
3. Using app notifications and email campaigns to encourage frequent casual riders to convert to annual members

### Business Task:
The marketing director believes that expanding Cyclistic’s base of annual members is essential for future growth.
...
- **Outcome:** Created an interactive dashboard to visualize trends and key metrics.

### [Project 2: Customer Churn Prediction](link-to-project)
- **Goal:** Predict customer churn using machine learning.
- **Tools:** Python, scikit-learn, matplotlib
- **Outcome:** Built a classification model that achieved 85% accuracy.
